                    ...
                    if (el.closest("[data-spoller]")) {
                        ...
                        if (!spollersBlock.querySelectorAll("._slide").length) {
                            if (oneSpoller && !spollerTitle.classList.contains("_spoller-active")) {
                                ...
                                let item = document.querySelectorAll(".FAQ-spollers__item");
                                console.log(item);
                                item.forEach((item => {
                                    item.classList.remove("active");
                                }));
                                console.dir(el.parentElement.classList.add("active"));
...
***************************************************************************** */
        ...
        function initSliders() {
            if (document.querySelector(".reviews-swiper", ".swiper-tariffs", ".swiper-metall", ".swiper-information", ".swiper-story", "swiper-form-lombard", ".swiper-lombard-image")) {
                ...
                new core(".swiper-tariffs", {
                    modules: [ Navigation, Pagination ],
                    spaceBetween: 16,
                    navigation: {
                        prevEl: ".button-prev-tariffs",
                        nextEl: ".button-next-tariffs"
                    },
                    pagination: {
                        el: ".swiper-pagination",
                        clickable: true
        ...
        if (document.querySelector(".bottom-navigation")) {
            let last_scroll = 0;
            let ScrolTop = document.querySelector(".bottom-navigation");
            window.onscroll = function() {
                if (window.scrollY > last_scroll) {
                    ScrolTop.classList.add("bottom-navigation_scroll-bottom");
                    ScrolTop.classList.remove("bottom-navigation_scroll-top");
                } else {
                    ScrolTop.classList.add("bottom-navigation_scroll-top");
                    ScrolTop.classList.remove("bottom-navigation_scroll-bottom");
                }
                last_scroll = window.scrollY;
            };
        }
        if (document.querySelector(".lombard-addresses")) {
            let TrigerWrap = document.querySelectorAll(".tariffs-triger");
            let CartButton = document.querySelectorAll(".form-lombard__slide");
            let BtnCloceDetail = document.querySelectorAll(".form-lombard__line");
            let BtnCloceDetail1 = document.querySelectorAll(".lombard-addresses-cart__button");
            let BtnOpenCartMob = document.querySelectorAll(".button-address");
            let BtnOpenList = document.querySelector(".button-list");
            let Cart = document.querySelector(".lombard-addresses-cart");
            let BtnAllMob = document.querySelectorAll(".lombard-addresses__button");
            let WrapItemLombard = document.querySelectorAll(".form-lombard");
            for (let i = 0; i < TrigerWrap.length; i++) {
                const trigerWrap = TrigerWrap[i];
                let btnall = trigerWrap.querySelectorAll(".tariffs-triger__button");
                for (let e = 0; e < btnall.length; e++) {
                    const btn = btnall[e];
                    btn.addEventListener("click", (function(e) {
                        btnall.forEach((btnall => {
                            btnall.classList.remove("tariffs-triger__button_active");
                        }));
                        btn.classList.add("tariffs-triger__button_active");
                    }));
                }
            }
            for (let c = 0; c < CartButton.length; c++) {
                const CartButtonAll = CartButton[c];
                CartButtonAll.addEventListener("click", (function(e) {
                    let WrapItemLombard = document.querySelectorAll(".form-lombard");
                    for (let g = 0; g < WrapItemLombard.length; g++) {
                        const WrapItemLombardAll = WrapItemLombard;
                        console.dir(WrapItemLombardAll[0]);
                        WrapItemLombardAll[0].classList.remove("form-lombard_active");
                        WrapItemLombardAll[1].classList.add("form-lombard_active");
                    }
                    for (let l = 0; l < BtnCloceDetail.length; l++) {
                        const BtnCloceDetailAll = BtnCloceDetail[l];
                        BtnCloceDetailAll.addEventListener("click", (function(e) {
                            for (let u = 0; u < WrapItemLombard.length; u++) {
                                const WrapItemLombardAll = WrapItemLombard;
                                console.dir(WrapItemLombardAll[0]);
                                WrapItemLombardAll[1].classList.remove("form-lombard_active");
                                WrapItemLombardAll[0].classList.add("form-lombard_active");
                            }
                        }));
                    }
                    for (let l = 0; l < BtnCloceDetail1.length; l++) {
                        const BtnCloceDetailAll = BtnCloceDetail1[l];
                        BtnCloceDetailAll.addEventListener("click", (function(e) {
                            for (let u = 0; u < WrapItemLombard.length; u++) {
                                const WrapItemLombardAll = WrapItemLombard;
                                console.dir(WrapItemLombardAll[0]);
            ...
            for (let p = 0; p < BtnOpenCartMob.length; p++) {
                const element = BtnOpenCartMob[p];
                element.addEventListener("click", (function(e) {
                    for (let f = 0; f < BtnAllMob.length; f++) {
                        const elementAll = BtnAllMob[f];
                        console.log(element);
                        elementAll.classList.remove("lombard-addresses__button_active");
                        BtnAllMob.forEach((element => {
                            element.addEventListener("click", (function(e) {
                                element.classList.add("lombard-addresses__button_active");
                            }));
                        }));
                    }
                    WrapItemLombard.forEach((element => {
                        element.classList.remove("form-lombard_active");
                    }));
                    Cart.classList.add("lombard-addresses-cart_active");
                }));
            }
            BtnOpenList.addEventListener("click", (function(e) {
                console.log("asdsad");
                Cart.classList.remove("lombard-addresses-cart_active");
                for (let g = 0; g < WrapItemLombard.length; g++) {
                    const WrapItemLombardAll = WrapItemLombard;
                    WrapItemLombardAll[0].classList.add("form-lombard_active");
                }
        ...
        let checkbox_main = document.querySelector(".checkbox_main");
        checkbox_main.addEventListener("click", (function(e) {
            if (checkbox_main.querySelector("input[type=checkbox]").checked) {
                console.log("Да");
                document.querySelector(".estimation__title").style.opacity = 1;
            } else {
                console.log("Нет");
                document.querySelector(".estimation__title").style.opacity = 0;
            }
        }));
        let btnTrigerGold = document.querySelector(".gold");
        let btnTrigersilver = document.querySelector(".silver");
        let MetallItem = document.querySelectorAll(".metall-item");
        if (btnTrigerGold || btnTrigersilver) {
            btnTrigerGold.addEventListener("click", (function(e) {
                let MetalTitle = document.querySelectorAll(".prices-metall__title");
                MetalTitle.forEach((itemTitle => {
                    itemTitle.children[0].className = "block";
                    itemTitle.children[1].className = "none";
                }));
                MetallItem.forEach((MetallItem => {
                    if (MetallItem.classList.contains("metall-item_silver")) {
                        MetallItem.classList.add("metall-item_gold");
                        MetallItem.classList.remove("metall-item_silver");
                    }
                }));
            }));
            btnTrigersilver.addEventListener("click", (function(e) {
                let MetalTitle = document.querySelectorAll(".prices-metall__title");
                MetalTitle.forEach((itemTitle => {
                    itemTitle.children[0].className = "none";
                    itemTitle.children[1].className = "block";
                }));
                MetallItem.forEach((MetallItem => {
                    if (MetallItem.classList.contains("metall-item_gold")) {
                        MetallItem.classList.remove("metall-item_gold");
                        MetallItem.classList.add("metall-item_silver");
                    }
                }));
            }));
        }
